...
// https://github.com/jambonbill/jsSID/blob/master/jsSID-modified.js
...
function jsSID (bufferlen, background_noise)
{
 ...
 this.getAudioNode = function() { return jsSID_scriptNode; }
 this.seekTo = function(targetTime) {
  if (!loaded) return;
  var savedEnd = endcallback; endcallback = null;
  this.pause(); init(subtune);
  var samples = Math.floor(targetTime * samplerate);
  for (var i = 0; i < samples; i++) { play(); }
  endcallback = savedEnd;
  this.playcont();
 }

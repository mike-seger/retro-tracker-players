...
ChiptuneJsPlayer.prototype.createLibopenmptNode = function(buffer, config) {
  ...
  var scriptBufferSize = isAndroid ? 8192 : 2048;
  var maxFramesPerChunk = Math.max(4096, scriptBufferSize);
  var processNode = this.context.createScriptProcessor(scriptBufferSize, 0, 2);
